...
# Mobile
from ..viewsets.mobile.grievance.main_category_viewset import MainCategoryViewSet
from ..viewsets.mobile.grievance.sub_category_viewset import SubCategoryViewSet
from ..viewsets.mobile.waste_collection_bluetooth.waste_bluetooth_viewset import (WasteCollectionBluetoothViewSet,)
from ..viewsets.mobile.attendance_view.register import RegisterViewSet
from ..viewsets.mobile.attendance_view.recognize import RecognizeViewSet
from ..viewsets.mobile.attendance_view.employee_viewset import EmployeeViewSet
from ..viewsets.mobile.attendance_view.staff_profile_viewset import StaffProfileViewSet
from ..viewsets.mobile.attendance_view.attendance_list import AttendanceListViewSet
