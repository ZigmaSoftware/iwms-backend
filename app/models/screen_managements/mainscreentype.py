...
class MainScreenType(BaseMaster):
    ...
    CASCADE_SOFT_DELETE = ("mainscreens",)
    CACHE_SCOPES = ("main_screen_type_list", "main_screen_type_detail")
    ...
    @property
    def mainscreens(self):
        from .mainscreen import MainScreen
        return MainScreen.objects.filter(mainscreentype_id=self.unique_id)