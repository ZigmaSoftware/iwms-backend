...
class ComplaintTicket(BaseMaster):
    ...
    @property
    def source(self):
        from app.models.core_modules.complaint_management.masters import ComplaintSource
        if self.source_id:
    ...
    @property
    def language(self):
        from app.models.core_modules.complaint_management.masters import ComplaintLanguage
        if self.language_id:
