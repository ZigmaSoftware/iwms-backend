...
class PointCollectionSerializer(TenancyReadSerializerMixin, serializers.ModelSerializer):
    ...
    panchayat_id = serializers.CharField(
        source="collection_point_id.panchayat_id.unique_id",
        read_only=True
    )

    panchayat_name = serializers.CharField(
        source="collection_point_id.panchayat_id.panchayat_name",
        read_only=True
    )

    ward_id = serializers.CharField(
        source="collection_point_id.ward_id.unique_id",
        read_only=True
    )

    ward_name = serializers.CharField(
        source="collection_point_id.ward_id.ward_name",
        read_only=True
    )
    ...
    def get_latitude(self, obj):
        if obj.collection_point_id and obj.collection_point_id.latitude:
            return obj.collection_point_id.latitude
        return None 
    
    def get_longitude(self, obj):
        if obj.collection_point_id and obj.collection_point_id.longitude:
            return obj.collection_point_id.longitude
        return None
