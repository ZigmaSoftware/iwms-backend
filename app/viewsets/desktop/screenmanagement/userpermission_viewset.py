...
from app.models.screenmanagement.userpermission import UserPermission
from app.serializers.desktop.screenmanagement.userpermission_serializer import UserPermissionSerializer
