...
from app.models.vehicles.vehicleTypeCreation import VehicleTypeCreation
from app.serializers.desktop.vehicles.vehicletypecreation_serializer import VehicleTypeCreationSerializer


class VehicleTypeCreationViewSet(TenantModelViewSet):
