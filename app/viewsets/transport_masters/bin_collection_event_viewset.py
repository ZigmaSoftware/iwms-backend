...
from app.serializers.transport_masters.bin_collection_event_serializer import (
...
class BinCollectionEventViewSet(AuditViewSetMixin, CompanyScopedViewSet):
    ...
    def get_queryset(self):
        queryset = (
            BinCollectionEvent.objects.select_related(
                ...
                "trip_assignment_id__trip_definition_id__routeplan_id__vehicle_id",
    ...
    def _event_context(self, instance):
        ...
        return {
            ...
            "trip": getattr(assignment, "trip_definition_id", None),
            "event": instance,
