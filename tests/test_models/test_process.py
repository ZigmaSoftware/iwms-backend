...
class TestRoutePlanModel:

    def test_create(self, route_plan):
    ...
    def test_default_flags(self, route_plan):
    ...
    def test_unique_ids_differ(self, route_plan, company, project, district, city, zone, vehicle, supervisor):
        ...
        assert route_plan.unique_id != rp2.unique_id
