...
from api.models.screenmanagement.userpermission import UserPermission
from api.serializers.desktop.screenmanagement.userpermission_serializer import UserPermissionSerializer
