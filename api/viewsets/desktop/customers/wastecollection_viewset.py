...
from api.models.customers.wastecollection import WasteCollection
from api.serializers.desktop.customers.wastecollection_serializer import WasteCollectionSerializer
